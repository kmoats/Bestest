...
void plot::generate_plot(std::string plotname, std::string xtext, std::string ytext, double xmin, double xmax, double ymin, double ymax) {
	...
	for ( int c=0; c<1; c++) {
		...
		gc0 = new TGraph(60000);
		gc1 = new TGraph(60000);
		gc2 = new TGraph(60000);
		gc3 = new TGraph(60000);
		gc4 = new TGraph(60000);
		gc5 = new TGraph(60000);
		gc6 = new TGraph(60000);
		gc7 = new TGraph(60000);
		gc8 = new TGraph(60000);
		gc9 = new TGraph(60000);
		gc10 = new TGraph(60000);
		gc11 = new TGraph(60000);
		gc12 = new TGraph(60000);
		gc13 = new TGraph(60000);
		gc14 = new TGraph(60000);
		gc15 = new TGraph(60000);
		
		reject = new TGraph(60000);
