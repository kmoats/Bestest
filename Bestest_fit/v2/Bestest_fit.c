{
	...
	Double_t alphaem[Nmax], GF[Nmax], yGF[Nmax], thetaWSM[Nmax], thetaWBLH[Nmax], gSM[Nmax], gBLH[Nmax], vSM[Nmax], vBLH[Nmax], gA[Nmax], gB[Nmax], gY[Nmax], xs[Nmax], v1[Nmax], v2[Nmax], m1[Nmax], m2[Nmax], m4[Nmax], m5[Nmax], m6[Nmax], aS[Nmax], aG[Nmax], aY[Nmax], Lambda[Nmax];
	...
	while (!infile.eof())	
	{
		infile >> alphaem[i] >> GF[i] >> yGF[i] >> thetaWSM[i] >> thetaWBLH[i] >> gSM[i] >> gBLH[i] >> vSM[i] >> vBLH[i] >> gA[i] >> gB[i] >> gY[i] >> xs[i] >> v1[i] >> v2[i] >> m1[i] >> m2[i] >> m4[i] >> m5[i] >> m6[i] >> aS[i] >> aG[i] >> aY[i] >> Lambda[i];
